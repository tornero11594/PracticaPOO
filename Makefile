...
# Makefile para las prácticas P2, P3 y P4
#
...
# Generación automática de las dependencias correspondientes a los ficheros de
# cabecera que incluyen los ficheros de código fuente C++.
#
# Adaptado de:
#
...
# No funciona cuando $* es ../Tests-auto/fichero, porque -MM genera
# una regla con fichero, sin el camino.

%.d: %.cpp
	@${CXX} ${CPPFLAGS} -MM -MF $@ $<
	@sed --regexp-extended --in-place 's|(.*.o):|${<:.cpp=.o} $@:|g' $@
